...
--
-- Host: mysql:3306
-- Erstellungszeit: 04. Feb 2020 um 15:49
...
INSERT INTO `guest` (`id`, `name`, `isVegan`, `isVegetarian`, `avoidGluten`, `avoidPork`, `avoidFish`, `money`) VALUES
(1, 'Philipp', 0, 0, 0, 0, 1, 68.54),
(2, 'Hans-Peter', 0, 1, 0, 1, 0, 132.5);
